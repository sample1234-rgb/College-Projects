...
class Template_Editor:
    def __init__(self):
        ...
        self.Page.config(scrollregion=(0, 0, 800, 1000))
    ...
    def drag(self, event):
        ...
        # self.Obj.x2_entry.delete(0,'end')
        # self.Obj.x2_entry.insert(0,str(event.x))
        # self.Obj.y2_entry.delete(0,'end')
        # self.Obj.y2_entry.insert(0,str(event.y))
    def dnd_Move(self,event):
        pass
